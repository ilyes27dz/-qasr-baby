  ...
  return (
    <div style={{
      ...
      <form style={{
        ...
        <h2 style={{ color: "#ff9800", marginBottom: 28, fontWeight: 700, fontSize: "2rem", textAlign: "center" }}>تسجيل الدخول</h2>
        ...
        <div style={{ marginTop: 18, textAlign: "center" }}>
          <Link href="/signup" style={{ color: "#ff9800", fontWeight: 600, fontSize: 16 }}>تسجيل جديد</Link>
        </div>
      </form>
    </div>
  );
